...
impl From<TDate> for CborValue {
    fn from(t: TDate) -> CborValue {
        CborValue::Tag(0, Box::new(t.0.into()))
    }
}

impl From<TDateOrFullDate> for CborValue {
    fn from(t: TDateOrFullDate) -> CborValue {
        match t {
